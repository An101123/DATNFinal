...
class StudyGuideListPage extends Component {
  ...
  getStudyGuidesListById = async (levelStudyGuideId) => {
    var list = await ApiLevelStudyGuide.getStudyGuidesByLevelStudyGuide(
      levelStudyGuideId
    );
    this.setState({ studyGuides: list });
  };
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        <div>
          <h3 style={{ color: "#0473b3" }}> HƯỚNG DẪN SINH VIÊN NCKH</h3>
          <hr />
          <Row className="nckh">
            <Col xs="12">
