...
class PublishBookListPage extends Component {
  ...
  getPublishBooksListById = async (bookCategoryId) => {
    var list = await ApiBookCategory.getPublishBooksByBookCategory(
      bookCategoryId
    );
    this.setState({ publishBooks: list });
  };
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        <div>
          <h3 style={{ color: "#0473b3" }}> XUẤT BẢN SÁCH</h3>
          <hr />
          <Row className="nckh">
            <Col xs="12">
